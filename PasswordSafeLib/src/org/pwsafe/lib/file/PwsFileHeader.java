...
public class PwsFileHeader
{
	 ...
	 */
	public PwsFileHeader( InputStream is, PwsFile file )
	throws IOException, EndOfFileException
	{
		file.readBytes( is, RandStuff );
		file.readBytes( is, RandHash );
		file.readBytes( is, Salt );
		file.readBytes( is, IpThing );
	}
	...
	throws IOException, NoSuchAlgorithmException
	{
		...
		file.writeBytes( os, RandStuff );
		file.writeBytes( os, RandHash );
		file.writeBytes( os, Salt );
		file.writeBytes( os, IpThing );
