...
public abstract class PwsRecord implements Comparable
{
	...
	protected class Item
	{
		 ...
		 * @throws IOException
		 */
		public Item( InputStream is, PwsFile file )
		throws EndOfFileException, IOException
		{
			RawData = file.readBlock(is);
			...
			file.readDecryptedBytes( is, Data );
		}
	 ...
	 * @throws IOException
	 */
	PwsRecord( InputStream is, PwsFile owner, Object [] validTypes )
	throws EndOfFileException, IOException
	{
		super();
	 ...
	 * @throws IOException
	 */
	public PwsRecord(InputStream is, PwsFile owner, Object[] validTypes, boolean ignoreFieldTypes) throws EndOfFileException, IOException {
		super();
	 ...
	 * @throws IOException
	 */
	protected abstract void loadRecord( InputStream is, PwsFile file ) throws EndOfFileException, IOException;
	 ...
	 * @throws IOException
	 */
	protected abstract void saveRecord( OutputStream os, PwsFile file ) throws IOException;
	 ...
	 */
	public static PwsRecord read( InputStream is, PwsFile file )
	throws EndOfFileException, IOException, UnsupportedFileVersionException
	{
		switch ( file.getFileVersionMajor() )
		{
			case PwsFileV1.VERSION :
				return new PwsRecordV1( is, file );
	
			case PwsFileV2.VERSION :
				return new PwsRecordV2( is, file );
				
			case PwsFileV3.VERSION :
				return new PwsRecordV3( is, file );
		}
	 ...
	 * @throws IOException
	 */
	protected void writeField( OutputStream os, PwsFile file, PwsField field, int type )
	throws IOException
	{
		byte	lenBlock[];
		byte	dataBlock[];
		...
		file.writeEncryptedBytes( os, lenBlock );
		file.writeEncryptedBytes( os, dataBlock );
	}
	 ...
	 * @throws IOException
	 */
	protected void writeField( OutputStream os, PwsFile file, PwsField field )
	throws IOException
	{
		writeField( os, file, field, field.getType() );
	}
}
